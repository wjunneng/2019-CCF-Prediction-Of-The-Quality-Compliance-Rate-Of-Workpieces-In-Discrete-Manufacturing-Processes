...
if __name__ == '__main__':
    ...
    gp = SymbolicTransformer(generations=3, population_size=2000,
    ...
    for fold_, (trn_idx, val_idx) in enumerate(folds.split(boston.data, boston.target)):
        ...
        reg.fit(boston.data[trn_idx], boston.target[trn_idx], eval_set=[(boston.data[val_idx], boston.target[val_idx])],
